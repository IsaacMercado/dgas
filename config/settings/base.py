...
)  # (dgas/config/settings/base.py - 3 = dgas/)
APPS_DIR = ROOT_DIR.path("dgas")
...
MIGRATION_MODULES = {"sites": "dgas.contrib.sites.migrations"}
...
LOGIN_REDIRECT_URL = "users:user_perfil_detail"
...
# Celery
# ------------------------------------------------------------------------------
INSTALLED_APPS += ["dgas.taskapp.celery.CeleryAppConfig"]
if USE_TZ:
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "dgas.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
