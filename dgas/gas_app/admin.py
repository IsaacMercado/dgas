...
class CombustibleAdmin(admin.ModelAdmin):
    fieldsets = (
        ('Planificacion', {'fields': ('estacion', 'estado', 'apertura', 'completado', 'litros_planeados_g91', 'litros_planeados_g95', 'litros_planeados_gsl', 'fecha_planificacion'), 'classes': ['wide']}),
